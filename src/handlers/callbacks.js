...
const HELP_MENU = {
  help_main: {
    ...
    rows: [
      ...
      [[`🛡️ ${ff('Captcha')}`, 'help_captcha'],  [`🛡️ ${ff('AntiRaid')}`, 'help_raid'],    [`🛡️ ${ff('DDoS')}`, 'help_ddos']],
      [[`🛡️ ${ff('Protection')}`, 'help_protect'], [`🧽 ${ff('Cleaning')}`, 'help_clean'], [`⚙️ ${ff('Strict mode')}`, 'help_strict']],
  ...
  help_ddos: {
    title:
      ...
      `Users receive 3 warnings first; after the third warning they are muted for 5 minutes. No ban is used.\n` +
      `Bursts can trigger a short group lockdown, and the group owner/admins get an immediate DM alert.\n\n` +
      `<i>Telegram does not give bots an API to end a voice chat, so the invite attacker is contained and admins are alerted.</i></blockquote>`,
    back: 'help_main',
  },
  help_protect: {
    title:
      ...
      `/antiraid on|off [duration] — block new joins\n` +
      `/captcha on|off — verify new members</blockquote>`,
    back: 'help_main',
  },
  help_strict: {
    title:
  ...
  help_ai: {
    title:
      ...
      `I reply in your language, answer real questions clearly, and chat naturally when you are casual.\n` +
      `I never return abuse when someone is rude; I stay calm and respectful.\n\n` +
